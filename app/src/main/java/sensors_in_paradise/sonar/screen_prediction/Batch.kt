...
class Batch(private val dataSet: DataSet,private val windowStartIndexesPerRecording: ArrayList<ArrayList<Int>>)  {
    init {
    ...
    fun compile(model: TFLiteModel, progressCallback: ((Int)->Unit)?=null): Pair<Array<Array<FloatArray>>, Array<FloatArray>> {
