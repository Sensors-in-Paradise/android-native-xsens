...
class Matrix4x4Test {
    ...
    fun transformVectorTest() {
        ...
        val m = Matrix4x4.fromRows(arrayOf(1f,2f,1f,1f),arrayOf(0f,1f,0f,1f),arrayOf(2f,3f,4f,1f),arrayOf(1f,1f,1f,1f))
        val res = m *p1
    ...
    fun matrixTimesUnitMatrixTest() {
        val m1 = Matrix4x4.fromRows(arrayOf(1f,2f,1f,1f),arrayOf(0f,1f,0f,1f),arrayOf(2f,3f,4f,1f),arrayOf(1f,1f,1f,1f))
        val m2 = Matrix4x4()
    ...
    fun matrixTimesMatrixTest() {
        val m1 = Matrix4x4.fromRows(arrayOf(1f,2f,1f,1f),arrayOf(0f,1f,0f,1f),arrayOf(2f,3f,4f,1f),arrayOf(1f,1f,1f,1f))
        val m2 = Matrix4x4.fromRows(arrayOf(2f,5f,1f,1f),arrayOf(6f,7f,1f,1f),arrayOf(1f,8f,1f,1f),arrayOf(1f,1f,1f,1f))
